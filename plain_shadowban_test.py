# tls_client curl_cffi stealth_requests requests
...
for i in range(5):
    ...
    for t in ["requests", "curl_cffi", "tls_client", "StealthSession"]:
        print(f"   - {t}")
